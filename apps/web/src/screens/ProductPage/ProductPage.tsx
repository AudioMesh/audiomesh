...
const ProductPage = () => {
  ...
  const macLink = `https://github.com/audiomesh/audiomesh/releases/tag/desktop-v${version}-mac`;
  const winLink = `https://github.com/audiomesh/audiomesh/releases/tag/desktop-v${version}-win`;
  const linuxLink = `https://github.com/audiomesh/audiomesh/releases/tag/desktop-v${version}-linux`;
          ...
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={6}>
            ...
            >
              ...
              <VStack align="start" gap={5}>
                ...
                <VStack width="100%" gap={3}>
                  <LinkButton
                    href="https://play.google.com/store/apps/details?id=com.audiomesh.mobile"
                    target="_blank"
                    rel="noopener noreferrer"
                    width="100%"
                    variant="solid"
